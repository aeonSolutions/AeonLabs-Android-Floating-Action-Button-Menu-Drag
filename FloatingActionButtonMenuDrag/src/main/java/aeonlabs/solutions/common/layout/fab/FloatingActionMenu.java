package aeonlabs.solutions.common.layout.fab;
    ...
    private void moveElements(View v, float SetX, float SetY, float oldX, float oldY){
        ...
        for (int i = mButtonsCount - 1; i >= 0; i--) {
            ...
            if (child == mImageToggle){
                ...
                child.layout(imageLeft, imageTop, l + mImageToggle.getMeasuredWidth()*2, t + mImageToggle.getMeasuredHeight()*2);
            }else {
